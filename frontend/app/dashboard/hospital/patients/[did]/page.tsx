      ...
      <Card className="w-full max-w-md bg-white shadow-lg border-0">
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div key={index} className="border p-4 rounded space-y-2 bg-gray-50">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => handleDiseaseChange(index, 'disease_name', e.target.value)}
                      required
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => handleDiseaseChange(index, 'diagnosed_date', e.target.value)}
                      required
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => handleDiseaseChange(index, 'treatment_status', e.target.value)}
                      required
                    />
                  </div>
                  <Button
            ...
            <Button type="button" className="w-full bg-gray-600 hover:bg-gray-700" onClick={addDisease}>
              Add Another Disease
            </Button>
